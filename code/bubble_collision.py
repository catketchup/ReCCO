...
class BubbleCollision_Veff():
    ...
    def Approx_Veff_ISW_radial(self, theta_e):
        ...
        # need to select the range of Z_e, theta_e and a, which have been accounted for in Psi_i_chia(a, theta_e_i)
    ...
    def Approx_RQF_decDopp(self, theta_e):
        ...
        return self.Dv_e* 5/8*(3*cos_theta_e**2-1)*(A/self.r_H*(3/4*self.Delta_cos_theta_c_n(theta_e, 4) - 1/2*self.Delta_cos_theta_c_n(theta_e, 2)))
